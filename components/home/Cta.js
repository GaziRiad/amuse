...
function Cta() {
  return (
    <>
      <LampContainer className="hidden lg:flex">
        <div className="border-b border-primary-700 pb-16">
          ...
          <motion.h1
            ...
            className="mx-auto mb-16 max-w-lg bg-secondary-heading-gradient bg-clip-text text-center text-4xl text-[52px] font-bold leading-relaxed text-transparent"
          >
